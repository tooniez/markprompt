...
const Footer = ({ stars, status }: { stars: number; status: SystemStatus }) => {
  return (
    <div className="relative z-0 mx-auto max-w-screen-lg pt-8 sm:pt-16">
      <div className="mt-20 grid grid-cols-1 items-center gap-8 border-t border-neutral-900/50 pt-12 pb-20 sm:mt-36 sm:py-12 sm:px-8 lg:grid-cols-3">
