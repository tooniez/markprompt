...
--       (mv_fts.file_meta->>'title')::text,
--       (mv_fts.section_meta->'leadHeading'->>'value')::text
--     ] &@ ('Markprompt', array[1, 100, 10], 'idx_file_sections_fts')::pgroonga_full_text_search_condition
--   )
--   and (
--     mv_fts.private_dev_api_key = 'sk_test_y3EzJ2IAHBeUA7jUqyGk8V7RvhaoZGMK'
--   )
-- limit 10;
...
-- from mv_fts
-- where
--   mv_fts.section_content &@ 'Markprompt'
--   and (
--     mv_fts.private_dev_api_key = 'sk_test_y3EzJ2IAHBeUA7jUqyGk8V7RvhaoZGMK'
--   )
-- limit 10;
...
-- -- create index idx_file_sections_fts on file_sections using pgroonga ((array[content,(meta->'leadHeading'->>'value')::text]));
-- -- create index idx_files_meta_title_fts on files using pgroonga ((meta->'title'));
...
-- --   from files
-- -- where
-- --   meta->>'title' &@ ('Markprompt', array[100], 'idx_files_meta_title_fts')::pgroonga_full_text_search_condition
...
-- --   ] &@ ('Markprompt', array[1, 10], 'idx_file_sections_fts')::pgroonga_full_text_search_condition
