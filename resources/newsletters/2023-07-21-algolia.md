...
You can now combine LLM prompts with instant search in a single tab-based interface, because sometimes a quick lookup is more suited than asking a question, and vice versa.
